...
export const attractionsByDate: Record<string, Attraction[]> = {
  ...
  "2026-08-28": [
    { title: "teamLab Planets", time: "Morning", area: "Toyosu", note: "Timed-ticket anchor for the day before lunch.", href: "https://teamlabplanets.dmm.com/en", booking: "Book" },
    { title: "Toyosu lunch", time: "Midday", area: "Toyosu / Tokyo Station", note: "Eat around Toyosu, or use the Tokyo Station kaisen-don backup if the route shifts.", booking: "Flexible" },
    { title: "Hotel rest", time: "Afternoon", area: "Shintomicho", note: "Return to the apartment for a real jet-lag break.", booking: "Flexible" },
    { title: "Ginza sunset walk", time: "Evening", area: "Ginza", note: "Easy dusk stroll through Ginza after resting.", booking: "Flexible" },
  ],
  "2026-08-29": [
    { title: "Easy Tokyo day", time: "Morning", area: "Tokyo", note: "Keep the day light after the first full day.", booking: "Flexible" },
    { title: "Doraemon Exhibition", time: "Midday", area: "Tokyo", note: "Use this as the main kid-friendly anchor; confirm the exact venue and ticket window before locking it.", booking: "Flexible" },
    { title: "Shopping / indoor activities", time: "Afternoon", area: "Tokyo", note: "Keep this flexible for weather, crowds, and energy level.", booking: "Flexible" },
  ],
  "2026-08-30": [
    { title: "Sanrio Puroland", time: "10:00-16:00", area: "Tama Center", note: "Indoor theme-park day; reserve tickets and treat this as the day anchor.", href: "https://www.puroland.jp/language/", booking: "Book" },
    { title: "Return to Ginza", time: "Late afternoon", area: "Ginza", note: "Head back before the evening rush and keep dinner near the apartment.", booking: "Flexible" },
    { title: "Ginza dinner area", time: "Evening", area: "Ginza / Shintomicho", note: "Use one of the Ginza or near-hotel dinner choices already in the plan.", booking: "Flexible" },
  ],
  "2026-08-31": [
    { title: "Ginza / Tokyo shopping", time: "Morning", area: "Ginza / Tokyo Station", note: "Shopping-focused day with no heavy transit commitment.", booking: "Flexible" },
    { title: "Free activity block", time: "Afternoon", area: "Tokyo", note: "Keep one afternoon open for whatever the family most wants after arrival.", booking: "Flexible" },
    { title: "Hotel-side reset", time: "Late afternoon", area: "Shintomicho", note: "Protect a quiet break before dinner.", booking: "Flexible" },
  ],
  "2026-09-01": [
    { title: "Tokyo Disneyland", time: "Full day", area: "Maihama", note: "Full park day; buy official date-specific tickets.", href: "https://www.tokyodisneyresort.jp/en/tdl/", booking: "Book" },
  ...
  "2026-09-02": [
    { title: "Disney recovery morning", time: "Late morning", area: "Hotel", note: "Sleep in after the full park day.", booking: "Flexible" },
    { title: "Asakusa light route", time: "Afternoon option", area: "Asakusa", note: "Use only if the family has energy for a short cultural stop.", href: "https://www.senso-ji.jp/english/", booking: "Flexible" },
    { title: "Tokyo Station light route", time: "Afternoon option", area: "Tokyo Station", note: "Indoor shops and character goods if you want a lower-effort day.", href: "https://www.tokyoeki-1bangai.co.jp/en/shop/?area=area03", booking: "Flexible" },
    { title: "Ginza easy evening", time: "Evening", area: "Ginza", note: "Choose one light route, then keep the evening close to the apartment.", booking: "Flexible" },
  ],
  "2026-09-03": [
    { title: "Optional Yokohama day", time: "Morning", area: "Yokohama", note: "Only do this if everyone has the stamina for a longer day trip.", booking: "Weather" },
    { title: "Shin-Yokohama Ramen Museum", time: "Lunch anchor", area: "Shin-Yokohama", note: "Ramen-themed museum and lunch stop before moving to Minato Mirai.", href: "https://www.raumen.co.jp/english/", booking: "Flexible" },
    { title: "Minato Mirai", time: "Afternoon", area: "Yokohama", note: "Waterfront, malls, and skyline views.", href: "https://www.japan.travel/en/spot/2099/", booking: "Flexible" },
    { title: "Cosmo Clock 21 / waterfront walk", time: "Late afternoon", area: "Minato Mirai", note: "Ferris wheel or easy harbor walk before returning to Ginza.", href: "https://cosmoworld.jp/?lang=en", booking: "Flexible" },
  ],
  "2026-09-04": [
...
export const restaurantSuggestionSets: RestaurantSuggestionSet[] = [
  ...
  { date: "2026-08-30", meal: "Dinner", context: "Nihonbashi or Tokyo Station dinner backups plus Ginza yakitori and premium kaiten sushi", options: [...nihonbashiDinner, ginzaDinnerVariety[0], ginzaDinnerVariety[7]] },
  ...
  { date: "2026-09-01", meal: "Dinner", context: "Backups around Asakusa/Ryogoku plus Ginza yakitori and udon after Disneyland", options: [...asakusaDinner, ginzaDinnerVariety[1], ginzaDinnerVariety[4]] },
