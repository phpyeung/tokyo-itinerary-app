...
export const attractionsByDate: Record<string, Attraction[]> = {
  ...
  "2026-08-30": [
    { title: "Ginza shopping", time: "Morning", area: "Ginza", note: "Stay close to the apartment area; use walk-in lunch options since 銀座 八五 sold out.", booking: "Flexible" },
    { title: "Tokyo Station / Character Street", time: "Afternoon option", area: "Tokyo Station", note: "Pokemon, Ghibli, Snoopy character goods; close to Ginza for dinner.", booking: "Flexible" },
    { title: "Shibuya / Harajuku", time: "Afternoon option", area: "Shibuya", note: "Shopping and youth culture; return to Ginza-itchome for すし土風炉 dinner at 18:00.", booking: "Flexible" },
  ],
  "2026-08-31": [
    { title: "Toyosu Market morning", time: "Morning", area: "Toyosu", note: "Explore the market area before the confirmed 14:00 晶 sushi lunch.", booking: "Flexible" },
    { title: "晶 sushi lunch", time: "14:00", area: "Toyosu Market area", note: "CONFIRMED 14:00 reservation at 晶. Mandatory omakase course ¥15,000/person; counter seating.", booking: "Flexible" },
